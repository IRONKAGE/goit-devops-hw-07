...
*Завдяки Terragrunt, проблема "курки та яйця" вирішена! Вам більше не потрібно вручну коментувати файли чи створювати S3-бакети. Terragrunt автоматично створить інфраструктуру для стейту перед запуском Terraform.*
